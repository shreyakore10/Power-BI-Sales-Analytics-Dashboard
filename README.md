...
- **State** — Arizona, California, Colorado, Delaware, Florida, Georgia, Illinois, and more
...
- The **Consumer segment** dominates the customer base, making it the primary target audience.
- **Online payments** are the most preferred mode, followed closely by COD.
- **Office Supplies** has the highest order volume among all categories.
- **Seth Vernon** is the most frequent buyer by region count.
- The **South and East** regions show notable sales concentration on the map.
